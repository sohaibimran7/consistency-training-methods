...
from scripts.irpan_2510_27062.wrappers import read_external_result_export
...
def _parser() -> argparse.ArgumentParser:
    ...
    requests.add_argument(
        "--generator-identity",
        required=True,
        help="Canonical immutable identity of the model that will be trained and must generate the targets",
    )
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.command == "build-bct-requests":
        try:
            ...
            manifest = materialize_bct_target_requests(
                args.training_view,
                args.output,
